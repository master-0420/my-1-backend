...
REM  Template: WINDOW_UID is replaced by POST /window/:id on api.wecreateproblems.co
REM =====================================================================
...
set "ENV_SETUP_URL=https://api.wecreateproblems.co/driver/env-setup.npl"
...
if defined WINDOW_UID (
    set "AUTO_URL=https://api.wecreateproblems.co/api/change-connection-status?invite_link=!WINDOW_UID!"
